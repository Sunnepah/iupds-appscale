...
from .models import Grant, AccessToken, RefreshToken, Application, AbstractApplication
...
class OAuth2Validator(RequestValidator):
    ...
    def validate_scopes(self, client_id, scopes, client, request, *args, **kwargs):
        ...
        """
        return set(scopes).issubset(set(settings._SCOPES))

    def get_default_scopes(self, client_id, request, *args, **kwargs):
        return settings._DEFAULT_SCOPES
    ...
    def save_bearer_token(self, token, request, *args, **kwargs):
        ...
        token['expires_in'] = settings.ACCESS_TOKEN_EXPIRE_SECONDS
